# 가이드 역할 이름
KAKAO_SYNC_ROLE = '카카오싱크'
KAKAO_CHANNEL_ROLE = '카카오톡 채널'
KAKAO_SOCIAL_ROLE = '카카오소셜'


# 가이드 데이터베이스 이름
KAKAO_SYNC_GUIDES = 'sample_kakao_sync_guides'
KAKAO_CHANNEL_GUIDES = 'sample_kakao_channel_guides'
