...
def init_chat_processor_and_conversation_manager(gpt_model ="gpt-3.5-turbo", enable_multi_function=False):
    (functions,
     available_functions,
     init_memory,
     str_function_concept) = init_function_call_info(db_name='sample_kakao_sync_guides')
    # 채팅 프로세스초기화
...
def init_function_call_info(db_name, is_multi_function=False):
    functions = []
    available_functions = {}
    init_memory = []
